        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tighter mb-6">
              Resep <span className="text-brand">Rahasia</span> Turun-Temurun
              Sejak 2016
            </h2>
            <p className="text-cream/65 leading-relaxed mb-8 max-w-[55ch]">
              Holchick lahir dari passion menghadirkan ayam goreng terbaik.
              Setiap potong ayam dipilih dari peternakan lokal berkualitas,
              direndam dalam bumbu rahasia 12 rempah, lalu digoreng dengan
              teknik double-fry sampai golden crispy di luar dan juicy di dalam.
            </p>
